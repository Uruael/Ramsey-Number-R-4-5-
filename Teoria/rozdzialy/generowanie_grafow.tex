...
Warto zauważyć, że powstały zbiór 4 grafów zawiera dwa grafy izomorficzne, $G'_2$ i $G'_3$. Można więc powiedzieć, że zbiór $G'_n$ zawiera trzy zbiory grafów izomorficznych. W przypadku grafów trójwierzchołkowych wygenerowanych przez rozszerzenie grafów na rysunku \ref{rozszerzenietrzywierzcholki}, uzyskamy 8 grafów, ale jedynie 4 grupy izomorficzne. Trywialnie więc zauważyć, że jeżeli do $G'_n$ dodamy również rozszerzenia drugiogo grafu z \ref{rozszerzenietrzywierzcholki} przybędzie tylko jeden unikalny graf.
...
Orbitami tego grafu będą zbiory \{1\} oraz \{2,3\}.

Dzięku temu wiemy, że w kolejnym kroku nie trzeba podłączać nowego wierzchołka do obu wierzchołków z orbity, wystaczy zrobić to tylko dla jednego wierzchołka z orbity \{2,3\}, co widać na rysunku \ref{g2extend}.
...
Omównione ograniczenia porwadzą do powstania algorytmu generacji grafów w następującej formie:
