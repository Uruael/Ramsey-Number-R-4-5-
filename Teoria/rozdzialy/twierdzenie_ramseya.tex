...
\begin{theorem}
Dla dowolnej liczby całkowitej N, istnieje taka liczba punktów w przestrzeni, w pozycji ogólnej, zawiera podzbiór składający się z N punktów który tworzy wielokąt wypukły.
 \cite{erdoshappy} 
\end{theorem}
...
\item Znajdź najmniejszą liczbę wierzchołków dla których graf będzie zawierać klikę stopnia $n$ o kolorze czerwonym lub klikę stopnia $m$ o kolorze niebieskim. Rozwiązaniem dla tego problemu są liczby Ramseya. 
\end{itemize}
...
\begin{table}[H]
  \centering
%
\begin{tabular}{|p{0.9cm}|p{0.9cm}|p{0.9cm}|p{0.9cm}|p{0.9cm}|p{0.9cm}|p{0.9cm}|p{0.9cm}|p{0.8cm}|}
\hline
