...
\begin{definition}
Sklejanie grafów opiera się na połączeniu dwóch grafów wejściowych w celu uzyskania grafu wyjściowego o pożądanych charakterystykach.
\end{definition}
...
\section{Zakończenie algorytmu sklejania}
