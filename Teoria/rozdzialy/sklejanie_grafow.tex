...
\begin{proof}
  ...
  \begin{enumerate}
    \item $x \in K_3$
    \item $ \exists_{v \in K_3} \{v,x\} \in E(F) \land \neg \forall u \in K_3, \{u,w\} \in E(F)$ 
    \item $\neg\exists_{v \in K_3} \{v,x\} \in E(F)$
  \end{enumerate} 
  ...
  \begin{enumerate}
    \item $x \in N_4$
    \item $ \exists_{v \in N_4}, \{v,x\} \in E(F) \land \neg \forall u \in N_4, \{u,x\} \in E(F)$ 
    \item $\neg\exists_{v \in N_4} \{v,x\} \in E(F)$
  \end{enumerate} 
...
\textit{Autor rozdziału: Krzysztof Karpusiewicz}
\vspace{0.5cm}\newline
...
\begin{definition}
Przedział $P = [B_P, T_P]$ to zbiór stożków, ograniczony przez stożek górny $T_P$ i stożek dolny $B_P$, który zawiera wszystkie stożki spełniające zależność:  $$P=\{X: B_P \subseteq X \subseteq T_P\}$$ 
\end{definition}
...
\textit{Autorzy rozdziału: Mateusz Kołakowski, Jan Kwarciński}
\vspace{0.5cm}\newline
