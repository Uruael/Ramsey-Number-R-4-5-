...
\section{Podstawy teoretyczne}
  ...
  Innymi słowy, izomorfizm jest to takie przekształcenie grafu, które zachowuje wszystkie jego właściwości. Dwa grafy są izomorficzne, jeżeli ich wierzchołki można nazwać w taki sposób, 
