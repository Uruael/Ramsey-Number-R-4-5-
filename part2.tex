...
Jak łatwo zauważyć graf 1 i graf 5 oraz graf 2 i graf 6 są parami izomorficzne, więc możne odrzucić po jednym z każdej pary, zmniejszając liczbę grafów rozważanych w kolejnych krokach.  
   ...
   \end{theorem}
  Dzięki powyższemu twierdzeniu wiemy, że wszelkie próby rozszerzenia grafu nieramseyowskiego powodują powstanie grafów nieramseyowskich. Dzięki temu odrzucanie takich grafów na wczesnym etapie generacji nie powoduje odrzucenia żadnych pożądanych grafów. Dzięki takiemu odrzucaniu znacznie zmniejszona jest ilość grafów powstających na kolejnych etapach generacji, zwłaszcza dla grafów większego stopnia.
