...
Tak zdefiniowane stożki należy przyporządkować do wierzchołków  grafu G, tak aby w wyniku ich połączenia nie powstała kilka 4 lub zbiór niezależny 5.
...
Nasz program został zaimplementowany w języku C z wykorzystaniem biblioteki Nauty, która umożliwia łatwe obliczeniowo wykrywanie izomorfizmów.
